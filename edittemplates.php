            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">ADD TEMPLATES</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="TEMPLATE ID" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="TEMPLATE NAME" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Low IMAGE FILE</label>
                                        <br>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="Student" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="Blue" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
