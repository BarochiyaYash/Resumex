...
while ($row = mysqli_fetch_array($res)) {
    ...
    $image = imagecreatefrompng("4.4.png");
    ...
    $name = $row['full_name'];
    imagettftext($image, 100, 0, 1265, 340, $colorA, $font, $name);

    $ex = $row['expert'];
    imagettftext($image, 50, 0, 1265, 455, $colorA, $font, $ex);



        
    $address = "ABOUT ME";
    imagettftext($image, 40, 0, 1265, 680, $colorA, $font, $address);

    $addressA = wordwrap($row['about'], 50, "\n", true);
    imagettftext($image, 40, 0, 1265, 800, $colorA, $font, $addressA);
