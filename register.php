      ...
      <div class="checkout_area section-padding-150">
		...
		?>
                  ...
                  <div class="col-12  mb-12">
                      <br>
                      <label for="email_address">Name<span>*</span></label>
                    ...
                    <div class="col-12  mb-12">
                      ...
                      <div class="col-12  mb-12">
                        <br>
                        <label for="email_address">Mobile Number<span>*</span></label>
                    ...
                    <div class="col-12">
                      ...
                      <center>
                        <div class="col-12  mb-12">
                          <input type="submit" class="btn essence-btn" id="customCheck2" value="Register" name="ok">
                          <!-- <a href="#" name="ok"></a> -->
                        </div>
                      </center>
                    </div>
